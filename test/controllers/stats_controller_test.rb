...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { hits: @stat.hits, sanitized_url: @stat.sanitized_url, shorturl: @stat.shorturl, url: @stat.url } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { hits: @stat.hits, sanitized_url: @stat.sanitized_url, shorturl: @stat.shorturl, url: @stat.url } }
